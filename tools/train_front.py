...
class Trainer():
    ...
    def train_epoch(self, epoch):
        ...
        self.writer.add_image("train_input", self.tset.to_rgb(x_c[0].cpu()), epoch+1, dataformats='HWC')
    ...
    def validate(self, epoch):
        ...
        self.writer.add_image("val_input", self.tset.to_rgb(x_c[0].cpu()), epoch+1, dataformats='HWC')
